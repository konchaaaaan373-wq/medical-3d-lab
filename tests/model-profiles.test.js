...
test('every solver scene is mechanistic, amyloid is illustrative and the brain atlas claims no mechanism', () => {
  ...
  assert.deepEqual(levels, {
    ...
    'pelvis-anatomy': MECHANISM_LEVEL.NONE,
    'abdomen-anatomy': MECHANISM_LEVEL.NONE,
    'thorax-anatomy': MECHANISM_LEVEL.NONE,
    'elbow-anatomy': MECHANISM_LEVEL.NONE,
    'neck-anatomy': MECHANISM_LEVEL.NONE,
    'skeleton-overview': MECHANISM_LEVEL.NONE,
    'foot-anatomy': MECHANISM_LEVEL.NONE,
