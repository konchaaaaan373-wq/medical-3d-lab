...
export class BowelObstructionScene {
  static meta = {
    ...
    subtitle: 'Above it fills and below it empties — and where the wall carries the most depends on the place',
    subtitleJa: '上流は溜まり、下流は空になります。そして壁の負担が最大になる場所は、閉塞の位置によって変わります',
    stages: STAGES,
    related: RELATED,
