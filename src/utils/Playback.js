 ...
 *
 * It used to also pause on each stage boundary while playing, which was the old
 * story mode. The guided sequence replaced that with an authored storyboard —
 * one that holds the progression still for whole steps and moves the camera
 * with it — so the hold machinery is gone rather than left here unreachable.
 */
