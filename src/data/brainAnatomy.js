...
const LABEL_PLACEMENT = {
  ...
  // it under the cerebellum (see STRUCTURE_NOTE above, and F-121-adjacent
  // finding #1 of the 2026-09-16 AI terminology check).
  'Base of peduncle': {
    category: 'brainstem',
...
const STRUCTURE_NOTE = {
  ...
  'Medulla oblongata': copy(
    'The source data includes only a left-side mesh; there is no right-side mesh (F-122).',
    '元データには左側のメッシュのみ収録されており、右側はありません（F-122）。'
  ),
  'Optic chiasm': copy(
