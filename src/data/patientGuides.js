...
export const PATIENT_GUIDES = Object.freeze({
  ...
  'multinodular-goitre': Object.freeze({
    ...
    steps: Object.freeze([
      ...
      },
      {
        ...
        focus: ['trachea'],
        certainty: 'established',
        title: 'In the neck, it mostly pushes the airway across',
        titleJa: '頸部では、多くは横へ押しやります',
        body: 'The neck gives way readily, so most of the growth moves the airway to one side rather than squeezing it. Some of it does still press in, and the airway is a little narrower as well.',
        bodyJa: '頸部は周りが逃げやすいため、増えた分の多くは気道を横へ動かします。ただし一部は押し込むほうへ回り、気道は少し細くもなります。',
        look: 'The airway has bent away from the larger side. It is also a little narrower where the gland meets it.',
        lookJa: '気道は大きいほうと反対側へ曲がり、腺が接する部分では少し細くもなっています。',
      },
      {
        progress: 1,
        stage: 'large',
        ...
        focus: ['trachea'],
        certainty: 'established',
        title: 'Larger still, and mostly still moved',
        titleJa: 'さらに大きくなっても、主に動かされます',
        body: 'Twice as much tissue moves it twice as far and narrows it twice as much. Where there is somewhere to go, most of it goes into moving.',
        bodyJa: '組織が 2 倍になれば、押しやる量も細くなる量も 2 倍です。逃げ場がある限り、その多くは「動かす」ほうへ回ります。',
        look: 'It is well off the midline now, and a little narrower than it was.',
        lookJa: '正中からかなり外れ、以前より少し細くなっています。',
      },
      {
        progress: 1,
        stage: 'large',
        ...
        certainty: 'established',
        title: 'Down behind the breastbone, there is less room',
        titleJa: '胸骨の裏では、逃げ場が乏しくなります',
        body: 'The way into the chest is ringed by bone, and what surrounds the gland there cannot move aside. So the same amount of tissue goes mostly into narrowing the airway rather than moving it.',
        bodyJa: '胸へ入る口は骨に囲まれ、そこでは腺の周りのものが逃げられません。そのため同じ量の組織の多くが、動かすことではなく細くすることに使われます。',
  ...
  'pressure-injury': Object.freeze({
    title: 'Why the skin is not always where the worst of it is',
    titleJa: '最も強く押されるのが皮膚とは限らない理由',
    steps: Object.freeze([
      {
        progress: 0,
        stage: 'unloaded',
        frame: 'block',
        focus: ['skin'],
        // Nothing pressing: the layers, and the question of what is beneath.
        controls: { ground: 'none' },
        certainty: 'established',
        title: 'Layers, and whatever happens to lie under them',
        titleJa: '層と、その下にたまたまあるもの',
        body: 'Skin is a surface layer, a thicker one under it, and fat below that. Nothing is pressing on any of it here. What lies underneath is the question the rest of this turns on.',
        bodyJa: '皮膚は、表面の層、その下の厚い層、さらに下の脂肪でできています。ここではどこにも力はかかっていません。下に何があるかが、以降の分かれ目です。',
        look: 'A block of skin cut out and seen from the side, so all three layers are open to view at once.',
        lookJa: '皮膚を切り出したブロックを横から見ています。3 つの層が同時に見えます。',
      },
      {
        progress: 0.5,
        stage: 'pressed',
        frame: 'block',
        focus: ['load', 'skin'],
        // The picture a reader arrives with, drawn honestly first.
        controls: { ground: 'soft-tissue' },
        certainty: 'established',
        title: 'Pressed from above, with only more tissue beneath',
        titleJa: '上から押す。下は軟らかい組織だけ',
        body: 'Something rests on the surface. Every depth feels it, but not equally: with only soft tissue below, the squeeze fades as it goes down, and the surface takes the most of it.',
        bodyJa: '表面に何かが載っています。どの深さにも力は及びますが、均等ではありません。下が軟らかい組織だけなら、力は下へ行くほど弱まり、最も受け止めるのは表面です。',
        look: 'A bar beside each depth, as long as how hard that depth is being squeezed. The top bar is the longest.',
        lookJa: '各深さの横にある棒の長さが、その深さの押され方です。いちばん上の棒が最長です。',
      },
      {
        progress: 1,
        stage: 'caught',
        ...
        focus: ['skin', 'squeezed'],
        certainty: 'established',
        title: 'Pressing harder makes it more, not different',
        titleJa: '強く押しても、増えるだけで変わりません',
        body: 'The bars all grow, and their shape stays as it was. Which depth is being squeezed hardest has not moved, because nothing about what lies underneath has changed.',
        bodyJa: '棒はどれも伸びますが、形はそのままです。最も強く押されている深さは変わっていません。下にあるものが何も変わっていないからです。',
        look: 'The longest bar is still the top one. Only the lengths changed.',
        lookJa: '最長の棒はいまも最上段です。変わったのは長さだけです。',
      },
      {
        progress: 1,
        stage: 'caught',
        frame: 'under',
        focus: ['bone'],
        // The second ground appears. Everything the scene exists for is here.
        controls: { ground: 'bony-prominence' },
        certainty: 'established',
        title: 'Now put a bone close underneath',
        titleJa: 'すぐ下に骨を置いてみます',
        body: 'In many places on a body there is bone just below the skin, with only a little tissue between. The same load now has something to press that tissue against.',
        bodyJa: '体の多くの場所では、皮膚のすぐ下に骨があり、あいだの組織はごくわずかです。同じ荷重が、その組織を押しつける相手を得たことになります。',
        look: 'The pale rounded shape below the block is the bone. It is drawn by this picture, not by the skin.',
        lookJa: 'ブロックの下の淡い丸い形が骨です。皮膚ではなく、この絵が描き加えたものです。',
      },
      {
        progress: 1,
        stage: 'caught',
        ...
        focus: ['squeezed', 'skin'],
        certainty: 'established',
        title: 'The longest bar has moved to the bottom',
        titleJa: '最長の棒が下端へ移りました',
        body: 'Tissue caught between the load above and the bone below is squeezed from both sides at once. The hardest-squeezed depth is now the deepest one, and the surface takes less than it did.',
        bodyJa: '上の荷重と下の骨に挟まれた組織は、両側から同時に押されます。最も強く押される深さはいま最深部にあり、表面はむしろ以前より弱くなっています。',
        look: 'The coloured bar is the one being squeezed hardest. It is at the bottom of the block now, not at the skin.',
        lookJa: '色のついた棒が、最も強く押されている深さです。いまは皮膚ではなくブロックの下端にあります。',
      },
      {
        progress: 1,
        stage: 'caught',
        ...
        educationalOnly: true,
        certainty: 'associated',
        title: 'Why anyone would want to know that',
        titleJa: 'なぜそれを知りたいのか',
        body: 'Harm that starts deep and reaches the surface later is described, which is why what the skin looks like early on is not taken as the whole account. None of that is worked out here.',
        bodyJa: '深部から始まり、後から表面に及ぶ障害が語られます。だから早い時期の皮膚の見た目だけでは全体を語れないとされます。そのいずれも、ここでは導いていません。',
        look: 'Nothing new is drawn for this step, and nothing on screen has been harmed or lost.',
        lookJa: 'この段階で新しく描かれるものはありません。画面上で損なわれたものも失われたものもありません。',
      },
      {
        progress: 1,
        stage: 'caught',
        ...
        educationalOnly: true,
        certainty: 'established',
        title: 'This picture does not put a number or a grade on anything',
        titleJa: 'この絵は等級も番号もつけません',
        body: 'Everything here is how hard a depth is being pressed compared with the others beside it. How far along something is, and how it would be described, are not worked out on this screen.',
        bodyJa: 'ここにあるのは、ある深さが隣の深さに比べてどれだけ押されているかだけです。どの段階にあたるかは、この画面のどこでも導いていません。',
        look: 'Where a grade would be listed, the screen says it is not in this model — rather than leaving the line out.',
        lookJa: '等級が並ぶはずの場所には、行を省くのではなく「このモデルにはありません」と出ています。',
      },
    ]),
  }),

  'breast-lesion': Object.freeze({
    title: 'Why where it is matters more than how far along it is',
    titleJa: '「どこか」が「どこまで進んだか」より意味を持つ理由',
    steps: Object.freeze([
      {
        progress: 0,
        stage: 'at-the-nipple',
        frame: 'gland',
        focus: ['nipple', 'route'],
        controls: { site: 'upper-outer' },
        certainty: 'established',
        title: 'Every duct in the breast ends at one place',
        titleJa: '乳房のすべての乳管は 1 か所に集まります',
        body: 'The milk ducts all run to the nipple, and from there they spread outwards through the breast in different directions. Somewhere in the breast means: on which of them, and how far out.',
        bodyJa: '乳管はすべて乳頭に集まり、そこから乳房の中を、それぞれ違う方向へ外側に広がっています。「乳房のどこか」とは、どの乳管の、どのあたりか、ということです。',
        look: 'The pale line running to the upper outer corner is the way this breast drains, towards the armpit.',
        lookJa: '外側上方へ伸びる淡い線が、この乳房が腋の方向へ流れていく道筋です。',
      },
      {
        progress: 0.5,
        stage: 'out-along-it',
        ...
        focus: ['marker'],
        certainty: 'established',
        title: 'Out along one of them',
        titleJa: 'そのうちの 1 本に沿って外へ',
        body: 'Near the nipple a duct is wide; further out it narrows, and at its far end sit the small clusters the milk is made in. A place further out is a place in a different part of the same duct.',
        bodyJa: '乳頭の近くで乳管は太く、外側へ行くほど細くなり、その末端に、乳汁がつくられる小さな房が並びます。外側の場所とは、同じ乳管の別の部分ということです。',
        look: 'The marker is a place, not a lump. It is drawn the same size wherever it goes.',
        lookJa: 'マーカーは場所であって、しこりではありません。どこへ動いても大きさは同じです。',
      },
      {
        progress: 1,
        ...
        focus: ['marker', 'route'],
        certainty: 'established',
        title: 'On this duct, further out is also closer',
        titleJa: 'この乳管では、外側は同時に「近く」でもあります',
        body: 'This one runs towards the corner the breast drains from, so the dotted line to that route gets shorter as the place moves out along it.',
        bodyJa: 'この乳管は、乳房が流れ出ていく角の方へ向かっています。そのため、場所が外側へ進むほど、その道筋までの点線は短くなります。',
        look: 'The dotted line is just the distance between two places. Nothing moves along it.',
        lookJa: '点線は 2 つの場所の間の距離です。そこを何かが移動するわけではありません。',
      },
      {
        progress: 1,
        stage: 'at-the-far-end',
        frame: 'course',
        focus: ['marker', 'duct'],
        controls: { site: 'lower-inner' },
        certainty: 'established',
        title: 'On another duct, further out is further away',
        titleJa: '別の乳管では、外側はむしろ「遠く」です',
        body: 'This one runs the other way. The place is just as far out along its duct as before, and the dotted line is now longer than it was at the nipple. Further along is not closer to anything.',
        bodyJa: 'こちらは反対方向へ向かいます。乳管に沿った進み具合は先ほどと同じですが、点線は乳頭にあったときより長くなっています。「先へ進む」ことは、何かに近づくことではありません。',
        look: 'Same distance out, opposite direction. Watch the dotted line rather than the marker.',
        lookJa: '外側への進み方は同じで、向きが逆です。マーカーではなく点線を見てください。',
      },
      {
        progress: 1,
        stage: 'at-the-far-end',
        frame: 'axilla',
        controls: { site: 'axillary-tail' },
        certainty: 'established',
        title: 'And the corner itself is a place of its own',
        titleJa: 'そして角そのものも 1 つの場所です',
        body: 'Breast tissue reaches into the upper outer corner, alongside the route. It is somewhere a place can be — not somewhere a place further along a duct arrives at.',
        bodyJa: '乳腺組織は、道筋に沿って外側上方の角まで伸びています。そこは「場所のひとつ」であって、乳管を進んだ先にたどり着く場所ではありません。',
        look: 'No duct is lit now, because this place is not on one. There is no dotted line either.',
        lookJa: 'いまはどの乳管も明るくなっていません。この場所は乳管上にないからです。点線もありません。',
      },
      {
        progress: 1,
        stage: 'at-the-far-end',
        ...
        educationalOnly: true,
        certainty: 'associated',
        title: 'Why that corner is the one people look at',
        titleJa: 'なぜその角が見られるのか',
        body: 'Fluid from most of the breast is described as leaving by that route and passing through the small bodies beyond it, which is why they are examined. None of that is worked out here.',
        bodyJa: '乳房の大部分の液は、その道筋を通って外へ出て、その先の小さな構造を通過すると説明されます。そこが調べられるのはそのためです。そのいずれも、ここでは導いていません。',
        look: 'Nothing new is drawn for this step, and nothing on screen has travelled anywhere.',
        lookJa: 'この段階で新しく描かれるものはありません。画面上で何かが移動したわけでもありません。',
      },
      {
        progress: 1,
        stage: 'at-the-far-end',
        ...
        educationalOnly: true,
        certainty: 'established',
        title: 'This picture has no size and nothing spreading in it',
        titleJa: 'この絵には大きさも、広がりもありません',
        body: 'Everything here is a place and a distance between two places. How big anything is, and whether anything has gone anywhere, are not worked out on this screen.',
        bodyJa: 'ここにあるのは、場所と、場所どうしの距離だけです。何かの大きさや、何かがどこかへ移ったかどうかは、この画面では導いていません。',
        look: 'Where a spread would be listed, the screen says nothing spreads here — rather than leaving the line out.',
        lookJa: '広がりが並ぶはずの場所には、行を省くのではなく「ここでは何も広がりません」と出ています。',
      },
    ]),
  }),
