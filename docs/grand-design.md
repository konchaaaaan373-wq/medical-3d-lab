...
| 指標 | 値 |
| --- | --- |
| シーン数 | 24（production 2 / reviewed 3 / alpha 5 / prototype 14） |
| カタログ | 11 系統・22 臓器（未カバー臓器は explorer 上で backlog として可視） |
| 医学モデル層（`src/models/`） | copd / asthma / portalHypertension / hepatorenal / renalFiltration / pulmonaryEdema / circulation の 7 本 + 共通ユーティリティ |
