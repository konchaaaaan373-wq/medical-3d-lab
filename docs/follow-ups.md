...
- **番号は Resolved も含めたファイル全体の最大値の次から取ります。**
  ...
  次に追加する番号は F-125 です（F-108〜F-110 は 2026-09-14〜15、F-111〜F-119 は
  09-15、F-120〜F-124 は 09-16 に採番済み）。⚠ **F-107 / F-108 も 2 回ずつ出ます。** 未マージの PR #73 と
...
### F-120 脳解剖：人間の臨床医・解剖学者による監修署名がまだ要る — P1（2026-09-16）
...
後横側副溝の別の不具合（右メッシュのノード名の先頭スペース）は F-124 を参照。

### F-124 「Posterior transverse collateral sulcus」ノード名の先頭スペースと検索 0 件 — P3（2026-09-16）
...
- **F-121 16 枚のレンダリング画像と単独選択画面をレビューアへ送る** — 解決（2026-09-17）。
