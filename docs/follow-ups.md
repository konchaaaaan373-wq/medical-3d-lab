...
- **番号は Resolved も含めたファイル全体の最大値の次から取ります。**
  ...
  次に追加する番号は F-130 です（F-108〜F-110 は 2026-09-14〜15、F-111〜F-124 は
  09-15、F-125〜F-129 は 09-16 に採番済み）。⚠ **F-107 / F-108 も 2 回ずつ出ます。** 未マージの PR #73 と
...
**20 件中 8 件が「人だけ」です**（L-01 / L-05 / L-06 / L-09 / L-13 / L-14 /
L-15 / L-16）。**L-04 は解決しました**——`scripts/lib/css.mjs`。
...
- どう確かめるか: `npm run lessons` の「8 of 20」が下がること。
