...
### F-125 教訓の 12 件は、まだ人しか捕まえられない — P2（2026-09-16）
...
**37 件中 12 件が「人だけ」です**——`npm run lessons` の出力から書いています
（2026-09-17 の再読でも 12 件のまま。増えたのはガードを持つ 5 件です）。
L-01 / L-05 / L-06 / L-09 / L-13 / L-14 / L-15 / L-16 / L-24 / L-26 / L-28 / L-36。
