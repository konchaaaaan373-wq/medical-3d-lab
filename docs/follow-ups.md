...
- **番号は、着手時に「ブロック」で予約します。** 最大値 +1 を 1 つ取る方式は、
  ...
  **予約中のブロック**（終わったら行ごと消す）:
  ...
  | **F-187〜F-196 / L-81〜L-90** | 心拍出量シーン（`cardiac-output`）の追加。使うのは F-180〜F-184・F-187・F-188・F-191・F-192 と L-81〜L-94・**L-105・L-106**（L-91〜L-94 は予約幅の外側、L-105〜L-107 は **採番し直し 3 回目**: L-95・L-96 を取ったところ #151 が先に L-95〜L-97 を使っていました。main を再 fetch して **L-105〜L-114 をこの branch のブロック**として取り直し、L-105〜L-107 を使っています） | 2026-09-22 |
