...
- **番号は Resolved も含めたファイル全体の最大値の次から取ります。**
  ...
  次に追加する番号は F-126 です（F-108〜F-110 は 2026-09-14〜15、F-111〜F-123 は
  09-15、F-124〜F-125 は 09-15〜16 に採番済み。**F-124 は未マージの PR #98 が
  確保しています**——この branch が F-125 を取っているのはそのためです）。
  ⚠ **F-107 / F-108 も 2 回ずつ出ます。** 未マージの PR #73 と
