...
- **番号は Resolved も含めたファイル全体の最大値の次から取ります。**
  ...
  次に追加する番号は F-126 です（F-108〜F-110 は 2026-09-14〜15、F-111〜F-124 は
  09-15、F-125 は 09-16 に採番済み）。⚠ **F-107 / F-108 も 2 回ずつ出ます。** 未マージの PR #73 と
...
- **F-111 モデルが 2 つ公開されたあとのヘッダーの出口** — 解決（2026-09-17）。
  ...
  **測定そのものが 3 回嘘をつきました**（L-21）。閉じた `<details>` の中身は
