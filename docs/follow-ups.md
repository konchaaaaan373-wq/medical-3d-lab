...
- **番号は、着手時に「ブロック」で予約します。** 最大値 +1 を 1 つ取る方式は、
  ...
  **予約中のブロック**（終わったら行ごと消す）:
  ...
  | **F-177〜F-186** | 心拍出量シーン（`cardiac-output`）の追加。使うのは F-177・F-178・F-180〜F-183（F-179 は書く前に解消したので穴。`origin/main` を fetch してから、そこの最大値 173 の上を取っています） | 2026-09-22 |
...
### F-177 心拍出量シーンの臨床レビューが未実施 — P1（心拍出量）
...
### F-178 スマホでは 3D がタイトルカードと数値パネルの下に潜る — P2（心拍出量）
