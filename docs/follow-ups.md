...
- **番号は Resolved も含めたファイル全体の最大値の次から取ります。**
  ...
  次に追加する番号は F-128 です（F-108〜F-110 は 2026-09-14〜15、F-111〜F-123 は
  09-15、F-124〜F-127 は 09-16 に採番済み）。⚠ **F-107 / F-108 も 2 回ずつ出ます。** 未マージの PR #73 と
...
### F-127 肺: hero の初期姿勢では Enter が何も選べない — P1（2026-09-16）
...
### F-124 腎・胃は「開いた視点からクリックで指せる構造」が 2 つしかない — P2（2026-09-16）
...
- **F-122 の見積もりを訂正します。** 「ゲートが通る＝公開できる」ではありません。
  6 件調べて 3 件が公開に耐えませんでした（本項 2 件 + F-125 の肩 1 件）
...
### F-125 肩: Show all のあとモデルをクリックしても何も選べない — P1（2026-09-16）
...
### F-126 公開できる臓器は hero builder のある 5 つに限られる — P1（2026-09-16）
