...
- **番号は、着手時に「ブロック」で予約します。** 最大値 +1 を 1 つ取る方式は、
  ...
  **予約中のブロック**（終わったら行ごと消す）:
  ...
  | **F-187〜F-196 / L-81〜L-90** | 心拍出量シーン（`cardiac-output`）の追加。使うのは F-180〜F-184・F-187・F-188 と L-81〜L-95（L-91〜L-95 は予約幅 10 の外側で、main の最大は L-72 なので衝突しません）。**採番し直し 2 回目**: L-64・L-65 → L-71・L-72 → L-81 以降、F-177〜F-186 → 空きを残して F-187 以降。どちらも main が先に取っていました | 2026-09-22 |
