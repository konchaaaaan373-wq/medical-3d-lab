...
- **番号は、着手時に「ブロック」で予約します。** 最大値 +1 を 1 つ取る方式は、
  ...
  **予約中のブロック**（終わったら行ごと消す）:
  ...
  | **F-197〜F-206 / L-94〜L-103** | ナビゲーションと App Shell の UX 監査（reading surface 間の document 再読込み廃止・共通ヘッダ・Trust の IA・boot veil）。使うのは F-197〜F-201 と L-94・L-95 | 2026-09-22 |
